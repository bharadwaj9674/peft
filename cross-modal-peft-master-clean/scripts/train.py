"""
Training script for cross-modal retrieval with PEFT.
"""
...
from src.data.flicker8k_dataset import get_dataloader
from src.training.trainer import CrossModalTrainer
from src.utils.parameter_counting import print_model_summary, compare_peft_methods
